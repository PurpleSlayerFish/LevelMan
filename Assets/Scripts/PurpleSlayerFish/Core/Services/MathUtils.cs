...
namespace PurpleSlayerFish.Core.Services
{
    public struct MathUtils
    {
        ...
        public Vector2 Direction2dFromRotate(float rotation) => Quaternion.AngleAxis(rotation, Vector3.forward) * Vector3.up;
        public Vector3 Direction3dFromRotate(float rotation, Vector3 direction) => Quaternion.AngleAxis(rotation, Vector3.up) * direction;
        ...
        public Vector2 RandomDirection() => Direction2dFromRotate(RandomAngle());
    }
}